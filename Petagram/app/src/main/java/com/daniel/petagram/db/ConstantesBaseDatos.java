...
public final class ConstantesBaseDatos {
    ...
    public static final String TABLE_MASCOTAS_SEXO = "sexo";
    public static final String TABLE_MASCOTAS_FOTO = "foto";

    public static final String TABLE_LIKES = "likes_mascota";
    public static final String TABLE_LIKES_ID = "id";
    public static final String TABLE_LIKES_ID_MASCOTA = "id_mascota";
    public static final String TABLE_LIKES_NUMLIKES = "numero_likes";
